 ...
 *
 * @see Plaza\Services\ElementsService::nearbyPost()
 *
 * @phpstan-type ElementNearbyPostParamsShape = array{
 *   lat?: float|null,
 *   limit?: int|null,
 *   lng?: float|null,
 *   near?: string|null,
 ...
 * }
 */
final class ElementNearbyPostParams implements BaseModel
{
    /** @use SdkModel<ElementNearbyPostParamsShape> */
    use SdkModel;
    use SdkParams;
