 ...
 *
 * @see Plaza\Services\ElementsService::queryPost()
 *
 * @phpstan-type ElementQueryPostParamsShape = array{
 *   bbox?: string|null,
 ...
 * }
 */
final class ElementQueryPostParams implements BaseModel
{
    /** @use SdkModel<ElementQueryPostParamsShape> */
    use SdkModel;
    use SdkParams;
