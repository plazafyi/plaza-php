...
use Plaza\Routing\RoutingIsochronePostResponse\Properties;
use Plaza\Routing\RoutingIsochronePostResponse\Type;
 ...
 * @phpstan-import-type PropertiesShape from \Plaza\Routing\RoutingIsochronePostResponse\Properties
 *
 * @phpstan-type RoutingIsochronePostResponseShape = array{
 ...
 * }
 */
final class RoutingIsochronePostResponse implements BaseModel
{
    /** @use SdkModel<RoutingIsochronePostResponseShape> */
    use SdkModel;
