 ...
 *
 * @see Plaza\Services\RoutingService::nearestPost()
 *
 * @phpstan-type RoutingNearestPostParamsShape = array{
 *   lat: float,
 *   lng: float,
 ...
 * }
 */
final class RoutingNearestPostParams implements BaseModel
{
    /** @use SdkModel<RoutingNearestPostParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new RoutingNearestPostParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * RoutingNearestPostParams::with(lat: ..., lng: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new RoutingNearestPostParams)->withLat(...)->withLng(...)
     * ```
     */
