 ...
 *
 * @phpstan-type AutocompleteRequestShape = array{
 *   q: string,
 ...
 * }
 */
final class AutocompleteRequest implements BaseModel
{
    /** @use SdkModel<AutocompleteRequestShape> */
    use SdkModel;
    ...
    /**
     * `new AutocompleteRequest()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AutocompleteRequest::with(q: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new AutocompleteRequest)->withQ(...)
     * ```
     */
