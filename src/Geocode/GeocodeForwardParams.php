 ...
 *
 * @see Plaza\Services\GeocodeService::forward()
 *
 * @phpstan-type GeocodeForwardParamsShape = array{
 *   q: string,
 *   bbox?: string|null,
 ...
 * }
 */
final class GeocodeForwardParams implements BaseModel
{
    /** @use SdkModel<GeocodeForwardParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new GeocodeForwardParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * GeocodeForwardParams::with(q: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new GeocodeForwardParams)->withQ(...)
     * ```
     */
