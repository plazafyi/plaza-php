 ...
 *
 * @see Plaza\Services\ElevationService::lookupPost()
 *
 * @phpstan-type ElevationLookupPostParamsShape = array{
 *   lat?: float|null,
 *   lng?: float|null,
 ...
 * }
 */
final class ElevationLookupPostParams implements BaseModel
{
    /** @use SdkModel<ElevationLookupPostParamsShape> */
    use SdkModel;
    use SdkParams;
